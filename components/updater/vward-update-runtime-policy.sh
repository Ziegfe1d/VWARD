...
vu_safe_target() {
    ...
    case "$target" in
        /opt/bin/adaptive-2ip-test.sh|/opt/bin/adaptive-auto-maint.sh|/opt/bin/adaptive-hints-update.sh|/opt/bin/adaptive-housekeeping.sh|/opt/bin/adaptive-resolve4.sh|/opt/bin/adaptive-route.sh|/opt/bin/agh-adaptive-live.sh|/opt/bin/agh-adaptive-route.sh|/opt/bin/crond-supervisor.sh|/opt/bin/vpn-domain-audit-chain.sh|/opt/bin/vpn-domain-audit.sh|/opt/bin/vpn-night-reconcile.sh|/opt/bin/vpn-subnet-sync.sh|/opt/bin/wan-guardian.sh|/opt/bin/wan-health-watch.sh|/opt/bin/wan-capability.sh|/opt/bin/wan-recovery-plan.sh|/opt/bin/wan-recovery-actuator.sh|/opt/bin/wan-recovery-controller.sh|/opt/bin/wg-failopen-guard.sh|/opt/bin/wg-health-watch.sh|/opt/etc/init.d/S90crond|/opt/etc/init.d/S91adaptive-live|/opt/etc/init.d/S92crond-supervisor|/opt/etc/init.d/S93keenetic-apps|/opt/etc/keenetic-apps/lighttpd.conf|/opt/share/keenetic-apps/www/index.html|/opt/share/keenetic-apps/www/cgi-bin/api.cgi|/opt/share/vward/VERSION)
            return 0
            ;;
        *)
            return 1
...
vu_activity_clear() {
    ...
    for conflict in \
        ...
        "$VU_ROOT_PREFIX/tmp/wan-recovery-controller.lock" \
