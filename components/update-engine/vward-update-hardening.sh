...
vu_target_mode_allowed() {
    target=$1 mode=$2
    case "$target" in
        /opt/share/vward/VERSION|/opt/share/vward/settings-registry.json|/opt/etc/vward/console/lighttpd.conf|/opt/share/vward/console/www/index.html|/opt/share/vward/console/www/assets/vward-console.css|/opt/share/vward/console/www/assets/vward-console.js|/opt/share/vward/console/www/cgi-bin/api.cgi|/opt/share/vward/ads-privacy-guard/*|/opt/share/vward/ads-privacy-guard/https/*|/opt/share/vward/ads-privacy-guard/https/providers/*|/opt/share/vward/route-engine/catalogs/*|/opt/lib/vward/vward-domain-classifier-lib.sh)
            [ "$mode" = 0644 ] ;;
        *) [ "$mode" = 0755 ] ;;
    esac
}
